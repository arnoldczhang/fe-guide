...
### integrity
> CSP的一种策略，对资源内容 base64 + sha-384 后，算出的摘要哈希
...
#### csp头部
[mdn参考](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy)
...
iframe可以通过[X-Frame-Options](#X-Frame-Options)解决

script和link可以通过[integrity](#integrity)解决

img可以通过监听`MutationObserver`解决
