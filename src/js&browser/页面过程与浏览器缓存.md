...
6. 服务端解析 url，设置请求报文（头、体）
7. 服务端返回 html，响应报文，4 次挥手
8. 浏览器渲染解析
...
**[缓存键](https://mp.weixin.qq.com/s/oOKvZAUKJEzx-KmhSaZotA)判断条件**

1. url
2. 请求方式
3. 请求头
4. cors属性（crossorigin='anonymous'）
...
- 200强缓存：cach-control、expires
- 304协商缓存：etag、last-modified
